...
cudaError_t ext_bitvec_test1();
namespace libcutests
{
	[TestClass]
	public ref class ext_bitvecTest
	{
	private:
...
#pragma endregion 
		...
		[TestMethod, TestCategory("ext")] void ext_bitvec_test1() { Assert::AreEqual("no error", gcnew String(cudaGetErrorString(::ext_bitvec_test1()))); }
	};
}
